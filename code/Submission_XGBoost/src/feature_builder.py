"""Shared feature engineering for the XGBoost submission pipeline.

This module intentionally follows the feature definitions from the previous
project version. It is imported by both training code and the submission
Predictor so that training and inference stay aligned.
"""
